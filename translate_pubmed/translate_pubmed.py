...
cloud_files = [x for x in tf.io.gfile.glob('gs://vien-translation/data/tranlsate_pubmed_with_vi_tag_512/*txt')]

os.system('mkdir vi')
existed_file = [x.split('-')[0] for x in os.listdir('vi')] + [x.replace('gs://vien-translation/data/tranlsate_pubmed_with_vi_tag_512/', '').split('-')[0] for x in cloud_files]
