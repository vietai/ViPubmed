...
model = MtfModel(
    ...
    sequence_length={"inputs": 512, "targets": 64},
...
file_name = 'test' # or val

with open(f'../data/FAQ_summarization/{file_name}.tsv') as test_file:
    with open('../data/FAQ_summarization/predict_input.txt', 'w') as out_file:
