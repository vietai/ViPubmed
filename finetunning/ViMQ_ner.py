...
parser.add_argument('-tokenized', dest='tokenized', type=str, help='Tokenized Type: syllable or word', default='syllable')
...
def dumping_dataset(split, shuffle_files = False):
    ...
    if split == 'train':
      ds = tf.data.TextLineDataset(
            [
            f'gs://vien-translation/data/ViMQ/train_ner_{TOKENIZED}.tsv',
            ]
          )
    else:
      ds = tf.data.TextLineDataset(
